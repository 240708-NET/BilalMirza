...
namespace CaesarCipher.Repository
{
	class CaesarCipher : ICipher
	{
		...
		public string Encrypt(string cipher_direction, string start_text, string shift_amount)
		{
			string end_text = "";
			int position;
			int new_position;
		...
		public string Decrypt(string cipher_direction, string start_text, string shift_amount)
		{
